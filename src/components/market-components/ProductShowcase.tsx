...
import { FaBolt, FaSun, FaExchangeAlt, FaChartLine } from "react-icons/fa";
            ...
            {activeTab === "transformers" ? (
              <div className="space-y-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Our transformers feature cutting-edge design with 99.2% energy
                  efficiency and smart monitoring capabilities. Built for
                  industrial applications with a 30+ year lifespan.
                </p>
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Our solar panels achieve 22.8% energy conversion efficiency
                  with durable construction and 25-year warranty. Ideal for
