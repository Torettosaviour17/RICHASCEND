  ...
  return (
    <footer className="bg-gray-900 text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-gray-800 hover:bg-red-700 w-10 h-10 rounded-full flex items-center justify-center transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-bold mb-6 border-l-4 border-red-600 pl-3">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-xl font-bold mb-6 border-l-4 border-red-600 pl-3">Our Services</h3>
            <ul className="space-y-3">
              {[
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-bold mb-6 border-l-4 border-red-600 pl-3">Contact Us</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@engineeringco.com</span>
              </li>
              <li className="flex items-start">
        ...
        {/* Newsletter */}
        <div className="bg-gradient-to-r from-red-700 to-red-900 rounded-xl p-8 mb-16">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="text-2xl font-bold mb-2">Subscribe to Our Newsletter</h3>
                <p className="text-red-100 max-w-lg">
                  Stay updated with our latest engineering innovations, project updates, and industry insights.
                </p>
              </div>
              <form className="flex w-full max-w-md">
                <input 
                  ...
                  className="px-4 py-3 w-full rounded-l-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-900"
                />
                <button 
                  type="submit"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-gray-500 hover:text-gray-400 transition-colors text-sm">Cookie Policy</a>
              <a href="#" className="text-gray-500 hover:text-gray-400 transition-colors text-sm">Sitemap</a>
            </div>
          </div>
        </div>
      </div>
